...
### [opredelenie] векторное пространство

### [primer] разные векторные пространства

### [opredelenie] линейное отображение и категория Vect

### [narrativ] в прошлый раз все стрелки были обратимы, здесь не все

### [opredelenie] изоморфизм
