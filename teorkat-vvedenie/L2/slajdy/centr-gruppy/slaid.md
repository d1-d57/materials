...
akcent: заполнить
centralnyj_blok: центр до функтора не продолжается
...
### [opredelenie] центр группы

### [primer] дорога туда и обратно между группой из двух элементов и S3

### [utverzhdenie] центр S3 тривиален

### [utverzhdenie] центр до функтора не продолжается
