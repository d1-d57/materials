...
tip_idei: proof_step
zachem: конструкция с прошлой лекции, красивая на биекциях, впервые оказывается запрещённой
akcent: заполнить
centralnyj_blok: до функтора не продолжается
...
### [opredelenie] инъекции в палитру из k цветов

### [narrativ] на биекциях это работало, и было на прошлой лекции

### [utverzhdenie] до функтора не продолжается
