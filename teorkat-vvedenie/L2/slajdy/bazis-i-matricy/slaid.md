...
akcent: заполнить
centralnyj_blok: изоморфны тогда и только тогда, когда размерности равны
...
### [opredelenie] базис и координаты

### [utverzhdenie] линейное отображение и матрица — одно и то же

### [utverzhdenie] изоморфны тогда и только тогда, когда размерности равны
