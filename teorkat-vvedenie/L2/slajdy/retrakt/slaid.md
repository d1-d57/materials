...
tip_idei: definition
zachem: то, что дважды делали руками, получает имя и становится инструментом
akcent: заполнить
centralnyj_blok: ретракция, сечение, ретракт
...
### [dokazatelstvo] три строки

### [utverzhdenie] рабочая форма — нет пары внизу, нет функтора наверху
