...
> поле:mn **Раскладка.** Один экран, одна сцена: четыре формулировки списком во всю ширину. Картинки у врезки нет — полоса справа пустая, лист читается сам.

> поле:mn **Адрес листа.** Полные формулировки — `teorkat-vvedenie/UPRAZHNENIYA-L1.md`, восемь позиций. На слайде оставлены четыре, и у каждой формулировка самодостаточна: видно, что дано и что доказать, определения напоминать не нужно. Снятые со слайда — Стоун, фробениусова алгебра, основная теорема об эквивалентности, симметрии на несвязном группоиде — лектор называет голосом со ссылкой на лист.
