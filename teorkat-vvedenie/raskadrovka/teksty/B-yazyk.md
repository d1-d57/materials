...
> поле:mn 🕳 **ПУСТО — ЗАКАЗ.** Свойства, которые появляются после того, как понятие названо. **Решение владельца:** какие именно свойства — не названо. «после того как понятие категория названа, нужно показать какие-то свойства» — какие, не сказано, и придумывать за него нельзя

## Справочная таблица: категории и функторы
