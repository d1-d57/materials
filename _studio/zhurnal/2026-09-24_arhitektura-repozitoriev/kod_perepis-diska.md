...
> 🔴 ГЕЙТ СБОРКИ ЗАПОЛНЕННОГО ФАЙЛА ОТКРЫТ КЛАПАНОМ (2026-09-24): `check_sborki.py` вернул rc=1 на заполненном файле, заход выдан вопреки красному, причина дословно: «межмашинный заход: собран в облаке, исполнен на Mac; С3 краснеет только на путях /Users/ivanyakovlev/... , которых нет на машине сборки; файлы существуют на Mac (ISTORII-CEN-zahoda.md есть в disciplina/_studio/docs/kak-delat/); п.99, п.112 SPISOK-DEL». Отключение видно здесь, в артефакте, а не осталось решением в голове аналитика.
