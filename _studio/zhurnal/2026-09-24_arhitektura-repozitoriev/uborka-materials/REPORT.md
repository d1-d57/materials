...
3. **Your unfinished work is untouched.** `materials` (147 changed files) and `disciplina` (206) look exactly as they did last night; copies of the unsaved changes of `materials`, `disciplina`, `ankety`, `matema-fest`, `matproekty-179`, `spetsmat-bot` and `vanya` are also saved on GitHub as branches `park/2026-09-25/<repo>-main` (your folders were not touched).
...
7. **Nothing was deleted from GitHub.** New branches there: `park/2026-09-25/…` (snapshots of unsaved changes, 210 of them).
