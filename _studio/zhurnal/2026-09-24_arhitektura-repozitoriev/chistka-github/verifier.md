...
Run 2026-09-25 12:17:30 — command: `python3 /tmp/chistka/verifier/verify.py`

Source: `actions.tsv` (574 rows total, 574 deletion rows).

| repo | deletion rows | checked | via trunk | via tag | failures |
|---|---|---|---|---|---|
| ankety | 2 | 2 | 1 | 1 | 0 |
| arhiv-london-avgust-2026 | 3 | 3 | 3 | 0 | 0 |
| disciplina | 350 | 350 | 183 | 167 | 0 |
