...
Run 2026-09-25 12:03:27 — command: `python3 /tmp/chistka/verifier/verify.py`

Source: `actions.tsv` (374 rows total, 374 deletion rows).

| repo | deletion rows | checked | via trunk | via tag | failures |
|---|---|---|---|---|---|
| ankety | 2 | 2 | 1 | 1 | 0 |
| arhiv-london-avgust-2026 | 3 | 3 | 3 | 0 | 0 |
| disciplina | 150 | 150 | 2 | 148 | 0 |
