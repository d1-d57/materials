...
```
git --no-optional-locks add -- {{ЗОНА}}
git --no-optional-locks commit -m "<зона>: <что сделано>"
python3 ../../../_generator/tools/git_zona.py check --zone <зона>   # должен быть ✅
```
