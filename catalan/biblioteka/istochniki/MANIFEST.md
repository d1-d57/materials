...
- `Sagan — Combinatorics, The Art of Counting (AMS prepub draft).pdf` — 325 стр. **Докачка Ф1a (обзор курса).** Самый полный НЕЗАВИСИМЫЙ голос жанра: покрывает почти весь интерес владельца (биекции · ПФ · ЧУМы · Юнг/RSK). Внутренний шов гл. 1–6 / 7–8 = граница «перечислительный низ / алгебраический верх».
- `Stanley — Topics in Algebraic Combinatorics (2013, free).pdf` — 225 стр. **Докачка Ф1a.** Свободный предшественник Springer-овского «Algebraic Combinatorics: Walks, Trees, Tableaux, and More». q-биномы и Юнг НЕ по Постникову — второй независимый вывод тех же тем.
- `Stanley — Enumerative Combinatorics vol.1 (2nd ed, 2011 draft).pdf` — 725 стр. **Докачка Ф1a.** Канон жанра. Заодно «отрицательный контроль»: q-аналогов и целочисленных разбиений отдельными главами в нём НЕТ — см. `../LANDSHAFT-kursov.md`.
- `Haglund — The q,t-Catalan Numbers and Diagonal Harmonics.pdf` — 173 стр. **Докачка Ф1a.** Закрывает дыру q,t-Каталана из `../POKRYTIE.md`. Аспирантский уровень — для обзора, скорее, горизонт, чем сюжет.

## konspekty/ — конспекты курсов (нужная «форма»)
- **`18.212 [official, Spring 2025]/`** — полный курс Постникова по лекциям (картиночный, с Drive — «тот самый»). **Нужны:** `Notes 01. Catalan Numbers`, `08. Trees`, `09. Arrangements, Parking`, `10. More Graphs`, `11. Misc Topics`. ~~Мимо (контекст курса): 02 Young · 03 Permutations · 04 Posets · 05 More Young · 06 q-Analogs · 07 Partitions~~ — **пометка «мимо» СНЯТА 2026-07-16 (Ф0.5 арки «Обзор курса»):** 02–07 вычитаны (96 стр.) и оказались несущими для обзора — там RSK с обратным ходом, Шпернер через SCD, q-биномы через F_q, пятиугольная теорема с инволюцией Франклина. Дайджест — `digest-18212-notes02-07.md`, записи — в `VYCHITANO.md` §Ф0.5. «Мимо» было верно для арки «Мир 2», не для обзора. (+ `info.pdf`, `diagrams.pdf`)
