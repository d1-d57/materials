...
# (`tipy._text_zone`) и съедает её высоту изнутри: 44px × 1.15 + margin 28px.
# Замер: 78.44px. ⚠ ОХВАТ: на калибровочной L2 заголовок пуст у 15 карточек из
# 15 (`grep -c 'zagolovok_na_ekrane: ""' teorkat-vvedenie/L2/slajdy/*/slaid.md`),
# то есть эта ветка формулы калибровкой НЕ ПРОВЕРЕНА — честная слепая зона.
ZAGOLOVOK_PX = 78.44
