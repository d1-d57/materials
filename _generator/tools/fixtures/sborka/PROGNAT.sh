...
echo "── ловушка 42: 🔴 (заход nositel) секция-носитель НЕ ловится С5 — на ОБЕИХ вёрстках"
...
echo "  ✅ ловушка 42: секция-носитель не ловится С5 ни в однострочной, ни в переформатированной вёрстке"
