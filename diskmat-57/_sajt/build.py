...
# читателя сайта.
#
# \b вокруг коротких токенов (бином) — иначе подстрока ловит слова длиннее себя.
#
# «граф» — НЕ в списке (снято Р119): Р64 ограничивает РЕЧЬ НА ЗАНЯТИИ, а не
# внутренний документ программы; ось в этом же файле называется "G": "графы",
# слово легально стоит в блоке «Игры» — предыдущая версия сторожа перечистила.
ZAPRET_OTMENENNOGO = [
    (r'процент',               'Р50'),
    (r'дроб',                  'Р50'),
    (r'доли и части',          'Р50'),
